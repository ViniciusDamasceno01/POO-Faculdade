	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= n; i++) {
			...
			if (resposta == 's') {
				...
				Funcionario func = new FuncionarioTerceirizado(nome, HorasTrabalhadas, ValorpHora, CustosAdicionais);
				list.add(func);

			} else {

				Funcionario func = new Funcionario(nome, HorasTrabalhadas, ValorpHora);
				list.add(func);
			}
